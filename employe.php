   ...
   <div class="sidebar_blog_1">
      <div class="sidebar-header">
         <div class="logo_section">
            <a href="employe.html"><img class="logo_icon img-responsive" src="images/logo/logo_icon.png" alt="#" /></a>
         </div>
      </div>
         ...
         <ul class="list-unstyled components">
            <li class="active">
               ...
               <ul class="collapse list-unstyled" id="dashboard">
                  <li>
                     <a href="employe.php?page=<?php echo base64_encode('pages/bord/lister00');?>">> <span>Tableau de bord 1</span></a>
                  </li>
                
               </ul>
            </li>
            <li><a href="#"><i class="fa fa-group blue1_color"></i> <span>Prestataires</span></a></li>
            <li><a href="employe.php?page=<?php echo base64_encode('pages/bord/lister00');?>"><i class="fa fa-shopping-cart blue1_color"></i> <span>Employer</span></a></li>
            <!-- Compétences -->
           
            <!-- Emplois -->
            <li><a href="employe.php?page=<?php echo base64_encode('pages/bord/lister_offre');?>"><i class="fa fa-briefcase green_color"></i> <span>Emplois</span></a></li>
  
            <li>
           
            <li><a href="employe.php?page=<?php echo base64_encode('pages/bord/produitss');?>"><i class="fa fa-shopping-cart blue1_color"></i> <span>Marketplace</span></a></li>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="employe.php?page=<?php echo base64_encode('pages/bord/profil');?>">Mon Profil</a>
                                       <a class="dropdown-item" href="employe.php?page=<?php echo base64_encode('pages/bord/profil');?>">Paramètres</a>
...
<section class="content">
        <div class="container-fluid">
           ...
           <?php 
            ...
            {
            include('pages/bord/lister00.php');
            }
              ?>
            <!-- Invoice Example -->
