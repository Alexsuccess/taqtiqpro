...
<bodyy  style="margin-top: 10%;">
    <main>


        <!-- Liste de tous les services -->
        <section class="main-section">
            <aside  style="margin-top: 1%; background-color: white; color: black;">
                <div class="p-2 p-md-3">
                    <div class="search-bar mb-2 mb-md-3">
                        <input type="search" class="form-control" placeholder="Rechercher une categorie...">
                    </div>
                    <nav>
                        <a href="#all" class="category-item" data-category-item="all" onclick="return filterServices('all');" style="color: black;">Tous</a>
                        <?php foreach($categories as $category): ?>
                            <a href="#<?= $category ?>" class="category-item" data-category-item="<?= $category ?>" onclick="return filterServices('<?= $category ?>');" style="color: black;"><?= $category ?></a>
                        <?php endforeach ?>
                    </nav>
                </div>
            </aside>
    ...
    <div class="offcanvas">
        <div class="inner p-2 p-md-3">
            ...
            <button type="button" class="btn btn-primary btn-order" data-toggle="modal" data-target="#commanderModal">Enregistrer</button>
        </div>
    </div>
