   ...
   <div class="container-fluid">
      ...
      <div class="row column1">
          ...
          <div class="col-md-6 col-lg-3">
            <a href="entreprise.php?page=<?php echo base64_encode('pages/bord/lister_new');?>">
               ...
               <div class="full counter_section margin_bottom_30">
                  ...
                  <div class="counter_no">
                     <div>
                        <p class="total_no">Signature du contrat</p>
                     </div>
                  </div>
               </div>
            </a>
        ...
        <div class="col-md-6 col-lg-3">
            <a href="entreprise.php?page=<?php echo base64_encode('pages/bord/presenter_candidat5');?>">
            <div class="full counter_section margin_bottom_30">
               <div class="couter_icon">
                  <div>
               ...
               <div class="counter_no">
                  <div>
                     <p class="total_no">main-d'œuvre</p>
          ...
          <div class="col-md-6 col-lg-3">
            <a href="entreprise.php?page=<?php echo base64_encode('pages/bord/enregistre_form');?>">
               ...
               <div class="full counter_section margin_bottom_30">
                  <div class="couter_icon">
                     <div>
                        <i class="fa fa-cloud-download" style="color: orange;"></i>
                     </div>
                  </div>
                  <div class="counter_no">
                     <div>
