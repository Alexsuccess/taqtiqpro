...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO candidats (type_candidat, categorie, nom, prenom, email, tel, prof, sexe, pays, city, exp, region, specail, ecrit, parle, permi, enfant, hum, hum1, user_id, code, datee) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, '1', ?, now())");
    ...
    if ($stmt->execute()) {
        ...
        $stmt_academique = $conn->prepare("INSERT INTO parcours_academique (candidat_id, diplome, institution, date_obtention, user_id, code) VALUES (?, ?, ?, ?, '1', ?)");
        ...
        $stmt_professionnel = $conn->prepare("INSERT INTO parcours_professionnel (candidat_id, poste, entreprise, periode, pays, user_id, code) VALUES (?, ?, ?, ?, ?, '1', ?)");
        ...
        $stmt_competence = $conn->prepare("INSERT INTO competencess2 (candidat_id, intitule, description, outils, references2, user_id, code) VALUES (?, ?, ?, ?, ?, '1', ?)");
