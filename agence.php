                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="dashboard">
                           <li>
                              <a href="agence.php?page=<?php echo base64_encode('pages/bord/lister232');?>">> <span>Tableau de bord</span></a>
                           </li>
                        </ul>
                     </li>
                  
                     <li>
                        <a href="#elementir" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-plane green_color"></i> <span>Candidats Immigration</span></a>
                        <ul class="collapse list-unstyled" id="elementir">
                        <li><a href="agence.php?page=<?php echo base64_encode('pages/immig/ajout7');?>">> <span>Ajouter</span></a></li>
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/immig/lister_imm333');?>">> <span>Mes candidats</span></a></li>
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/envoi_email_agence');?>">> <span>Suivi</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="elementi">
                           <li><a href="agence.php?page=<?php echo base64_encode('pages/bord/liester_offre100');?>">> <span>Lister les Offres</span></a></li>
                     ...
                     <li>
                        <a href="#elementig" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-comments-o red_color"></i> <span>Message</span></a>
                        <ul class="collapse list-unstyled" id="elementig">
                           <li><a href="pages/bord/message.php" target="_black">> <span>Lister</span></a></li>
                           

                        </ul>
                     </li>
                      <li>
                      <a href="agence.php?page=<?php echo base64_encode('pages/bord/profil');?>"><i style="color: white;" class="fa fa-users white_color"></i> <span style="color: white;"> Paramètres</span></a>
                      </li>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="agence.php?page=<?php echo base64_encode('pages/bord/profil');?>">Mon Profil</a>
                                       <a class="dropdown-item" href="agence.php?page=<?php echo base64_encode('pages/bord/profil');?>">Paramètres</a>
...
<section class="content">
        <div class="container-fluid">
           ...
           <?php 
            ...
            {
            include('pages/bord/lister232.php');
            }
              ?>
            <!-- Invoice Example -->
